...
// // const orangeVeg = vegetables.filter(v =>
// //     v.color == "orange"
...
// let lower = messagesFromDad.map(m=>m.toLocaleLowerCase())
// console.log(lower)
...
// const findCommentByID = (postID, commentID) => posts.find(p=> p.id=== postID).comments.find(p=> p.id===commentID)
...
// }
// let newMovies = movies.every(m=>m.year>2020)
// if(newMovies){
...
//ex1
//     // let newUsers =users.map(u=> (`email: "${u.email}", companyName: "${u.company.name}"`))
//     // console.log(newUsers)
// let newUsers = users.map(u=> {return {email:u.email, companyName: u.company.name}})
// console.log(newUsers)

// // //ex2
// let startWith =users.filter(u=> u.address.zipcode.charAt(1)==="5")
// // let startWith =users.filter(u=> u.address.zipcode[0]=="5")
// console.log(startWith)

// //ex3
// // let id = users.filter(u=>u.address.zipcode[0]=="5").map(u=>u.id)
// // console.log(id)

// //ex4
// let nameStartC = users.map(u=>u.name).filter((name) => name[0]=="C")
...
//ex6
// let userCompany = (users.find(u=>u.address.suite==="Apt. 950"))
// console.log(userCompany.company.name)

//ex7
// const names = function(user){
...
// console.log(people.find(r=>r.id === 2))
